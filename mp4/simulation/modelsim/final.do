...
add wave -noupdate -group EX/MEM /mp4_tb/dut/datapath/ex_stage/rs1mux_out
add wave -noupdate -group EX/MEM /mp4_tb/dut/datapath/ex_stage/rs2mux_out
add wave -noupdate -group EX/MEM /mp4_tb/dut/datapath/exmem_rs2_out
add wave -noupdate -group EX/MEM /mp4_tb/dut/datapath/mem_stage/dcacheforwardmux_out
add wave -noupdate -group EX/MEM /mp4_tb/dut/datapath/dcacheforwardmux_sel
...
WaveRestoreCursors {{Cursor 1} {4885195 ps} 0}
...
update
WaveRestoreZoom {4844644 ps} {5118703 ps}
